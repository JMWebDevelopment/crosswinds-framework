...
<div class="wp-block-group alignfull hero-section hero-section-cover-right"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/photo-placeholder.png","id":1891,"dimRatio":50,"minHeight":100,"minHeightUnit":"vh","align":"full"} -->
