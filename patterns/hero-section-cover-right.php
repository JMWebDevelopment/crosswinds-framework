<?php
/**
 * Title: Hero Section - Cover with Text Right
 * Slug: crosswinds-framework/hero-section-cover-right
...
<!-- wp:group {"align":"full","className":"hero-section hero-section-cover-right","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull hero-section hero-section-cover-right"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/welcome-to-mansfield.jpg","id":1891,"dimRatio":50,"minHeight":100,"minHeightUnit":"vh","align":"full"} -->
