<?php
/**
 * Title: Testimonials Section - 3x3 Grid with Contrast Background
 * Slug: crosswinds-framework/testimonials-section-3-box-grid-contrast
 * Categories: crosswinds-framework-testimonials
 * Viewport Width: 1200
 */
?>

<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|xx-small","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|xx-small"},"blockGap":"var:preset|spacing|small"},"elements":{"link":{"color":{"text":"var:preset|color|base"}}}},"backgroundColor":"contrast","textColor":"base","className":"testimonials-section testimonials-section-3-box-grid-contrast","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull testimonials-section testimonials-section-3-box-grid-contrast has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--xx-small);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--xx-small)"><!-- wp:heading {"textAlign":"center"} -->
