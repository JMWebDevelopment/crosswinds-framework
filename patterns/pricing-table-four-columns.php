<?php
/**
 * Title: Pricing Table - Four Columns
 * Slug: crosswinds-framework/pricing-table-four-columns
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|x-small"}}},"className":"pricing-table-section pricing-table-four-columns","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull pricing-table-section pricing-table-four-columns" style="padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:heading {"textAlign":"center"} -->
...
<div class="wp-block-column cb-flex-layout"><!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|x-small","right":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"},"blockGap":"var:preset|spacing|xxx-small"}},"backgroundColor":"neutral","className":"pricing-column pricing-column-paragraph-price-top","layout":{"type":"constrained"},"cbUseFlex":true,"cbInnerLayout":"last-bottom","cbFillHeight":true} -->
<div class="wp-block-group pricing-column pricing-column-paragraph-price-top has-neutral-background-color has-background last-bottom-layout cb-fill-height-parent" style="padding-top:var(--wp--preset--spacing--x-small);padding-right:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}},"fontSize":"large"} -->
