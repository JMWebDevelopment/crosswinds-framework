...
<!-- wp:query {"queryId":2,"query":{"perPage":"12","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"displayLayout":{"type":"flex","columns":3},"className":"query-pattern query-pattern-grid equal-layout cb-fill-height-parent","cbInnerLayout":"equal"} -->
<div class="wp-block-query query-pattern query-pattern-grid equal-layout cb-fill-height-parent"><!-- wp:post-template -->
