<?php
/**
 * Title: Pricing Table - Base with Three Columns
 * Slug: jm-web-dev-fse-starter-theme/pricing-table-base-three-columns
...
<div class="wp-block-column"><!-- wp:group {"style":{"border":{"width":"1px"},"spacing":{"blockGap":"0px"}},"borderColor":"contrast","className":"pricing-table last-bottom-layout cb-fill-height-parent","layout":{"type":"constrained"},"cbInnerLayout":"last-bottom"} -->
<div class="wp-block-group pricing-table last-bottom-layout cb-fill-height-parent has-border-color has-contrast-border-color" style="border-width:1px"><!-- wp:group {"style":{"elements":{"link":{"color":{"text":"var:preset|color|tertiary"}}},"spacing":{"padding":{"top":"var:preset|spacing|x-small","right":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"},"blockGap":"10px"}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained"}} -->
