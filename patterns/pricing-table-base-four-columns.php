<?php
/**
 * Title: Pricing Table - Base with Four Columns
 * Slug: jm-web-dev-fse-starter-theme/pricing-table-base-four-columns
 * Categories: jm-web-dev-fse-starter-theme-pricing-tables
 * Viewport Width: 1280
 */
?>

<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|x-small"}}},"className":"pricing-table-section pricing-table-base-four-columns","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull pricing-table-section pricing-table-base-four-columns" style="padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:heading {"textAlign":"center"} -->
