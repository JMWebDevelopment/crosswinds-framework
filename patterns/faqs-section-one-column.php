<?php
/**
 * Title: FAQs - One Column
 * Slug: crosswinds-framework/faqs-section-one-column
 * Categories: crosswinds-framework-faqs
 * Viewport Width: 800
 */
?>

<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","right":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|medium"},"blockGap":"var:preset|spacing|small"}},"className":"faqs-section faqs-section-one-column","layout":{"type":"constrained"}} -->
<div class="wp-block-group faqs-section faqs-section-one-column" style="padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:heading {"textAlign":"center"} -->
...
<!-- wp:crosswinds-blocks/accordions {"className":"basic-accordion"} -->
