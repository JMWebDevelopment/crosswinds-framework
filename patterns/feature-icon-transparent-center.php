...
<!-- wp:group {"style":{"spacing":{"blockGap":"10px"}},"className":"feature-item feature-icon-transparent-center","layout":{"type":"constrained"}} -->
<div class="wp-block-group feature-item feature-icon-transparent-center"><!-- wp:outermost/icon-block {"iconName":"wordpress-wordpress","itemsJustification":"center"} -->
