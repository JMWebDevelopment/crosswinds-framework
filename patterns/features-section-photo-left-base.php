<?php
/**
 * Title: Features Section - 2x2 Grid with Left Photo and Base Background
 * Slug: crosswinds-framework/features-section-photo-left-base
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|xx-small","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|xx-small"},"blockGap":"var:preset|spacing|small"}},"className":"features-section features-section-photo-left-base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull features-section features-section-photo-left-base" style="padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--xx-small);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--xx-small)"><!-- wp:columns {"verticalAlignment":null,"align":"wide"} -->
...
<h2 class="wp-block-heading has-text-align-left"><?php _e( 'Our Product\'s Features', 'crosswinds-framework' ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-large-font-size" style="font-style:normal;font-weight:600"><?php _e( 'Feature Heading', 'crosswinds-framework' ); ?></p>
<!-- /wp:paragraph -->
