<?php
/**
 * Title: Services Section - 2x2 Grid with Left Photo Contrast Background
...
<h2 class="wp-block-heading has-text-align-left"><?php _e( 'Our Services', 'crosswinds-framework' ); ?></h2>
<!-- /wp:heading -->
