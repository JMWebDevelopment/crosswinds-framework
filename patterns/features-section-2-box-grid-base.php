<?php
/**
 * Title: Features Section - 2x2 Grid with Base Background
 * Slug: crosswinds-framework/features-section-2-box-grid-base
 * Categories: crosswinds-framework-features
 * Viewport Width: 1200
 */
?>

<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|xx-small","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|xx-small"},"blockGap":"var:preset|spacing|small"}},"className":"features-section features-section-2-box-grid-base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull features-section features-section-2-box-grid-base" style="padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--xx-small);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--xx-small)"><!-- wp:heading {"textAlign":"center"} -->
