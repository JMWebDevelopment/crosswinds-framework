<?php
/**
 * Title: Testimonial - Neutral with Stars
 * Slug: crosswinds-framework/testimonial-neutral-stars
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|xx-small","padding":{"top":"var:preset|spacing|x-small","right":"var:preset|spacing|x-small","bottom":"var:preset|spacing|x-small","left":"var:preset|spacing|x-small"}}},"backgroundColor":"neutral","className":"testimonial testimonial-neutral-stars","layout":{"type":"constrained"}} -->
<div class="wp-block-group testimonial testimonial-neutral-stars has-neutral-background-color has-background" style="padding-top:var(--wp--preset--spacing--x-small);padding-right:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:paragraph {"fontSize":"x-large"} -->
