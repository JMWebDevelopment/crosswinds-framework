<?php
/**
 * Title: Services Section - 3x3 Grid with Base Background
 * Slug: crosswinds-framework/services-section-3-box-grid-base
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","right":"var:preset|spacing|xx-small","bottom":"var:preset|spacing|x-large","left":"var:preset|spacing|xx-small"},"blockGap":"var:preset|spacing|small"}},"className":"services-section services-section-3-box-grid-base","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull services-section services-section-3-box-grid-base" style="padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--xx-small);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--xx-small)"><!-- wp:heading {"textAlign":"center"} -->
<h2 class="wp-block-heading has-text-align-center"><?php _e( 'Our Services', 'crosswinds-framework' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-group feature-item feature-icon-transparent-left" style="padding-top:var(--wp--preset--spacing--x-small);padding-right:var(--wp--preset--spacing--x-small);padding-bottom:var(--wp--preset--spacing--x-small);padding-left:var(--wp--preset--spacing--x-small)"><!-- wp:outermost/icon-block {"iconName":"wordpress-wordpress"} -->
...
<p class="has-large-font-size" style="font-style:normal;font-weight:600"><?php _e( 'Service Heading', 'crosswinds-framework' ); ?></p>
<!-- /wp:paragraph -->
