...
<div class="options-wrap">
	...
	<div class="main-area">
		...
		<h1><?php esc_html_e( 'Crosswinds Framework Theme Options', 'jm-web-dev-fse-starter-theme' ); ?></h1>

		<div class="settings-area">
			<h2><?php esc_html_e( 'Check out the Crosswinds Framework Themes!', 'jm-web-dev-fse-starter-theme' ); ?></h2>
		</div>
