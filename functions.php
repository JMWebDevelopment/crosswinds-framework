...
function crosswinds_framework_add_admin_pages() {
	...
	if ( ! crosswinds_framework_if_child_theme_active() ) {
		add_submenu_page(
			'crosswinds-framework-block-options',
			esc_html__( 'Crosswinds Framework Options', 'crosswinds-framework' ),
			esc_html__( 'Theme', 'crosswinds-framework' ),
			'manage_options',
			'crosswinds-framework-theme',
			'crosswinds_framework_create_framework_theme_page'
		);
	}
}
 ...
 * @since 1.0
 */
function crosswinds_framework_create_framework_theme_page() {
 ...
 * @since 1.0
 */
function crosswinds_framework_load_admin_styles() {
...
add_action( 'admin_enqueue_scripts', 'crosswinds_framework_load_admin_styles' );
